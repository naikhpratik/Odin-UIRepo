...
namespace Odin.Helpers
{
        ...
        public class ViewRenderer
        {
            ...
            /// <returns>String of the rendered view or null on error</returns>
            public string RenderView(string viewPath, object model = null,
        ...
        {
            var context = CreateController<Odin.Controllers.ManageController>().ControllerContext;            
            string html = RenderView(viewName, model);
            return html;
        }
    }
